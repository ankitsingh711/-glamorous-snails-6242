...
async function fetchData(){
    let res = await fetch("http://localhost:3300/products/kids", {
        method:"GET",
        headers:{
...
async function ascendingPrice(){
    ...
    try {
        let res = await fetch("http://localhost:3300/products/kids?price=asc", {
            method:"GET",
            headers:{
...
async function descendingPrice(){
    showContainer.innerHTML = null;
    try {
        let res = await fetch("http://localhost:3300/products/kids?price=dsc",{
            method:"GET",
            headers:{
                "Content-Type":"application/json",
                Authorization: localStorage.getItem("token")
